...
static_assert(alignof(UBorder_ItemInfo_Locked_C) == 0x000010, "Wrong alignment on UBorder_ItemInfo_Locked_C");
static_assert(sizeof(UBorder_ItemInfo_Locked_C) == 0x0000F0, "Wrong size on UBorder_ItemInfo_Locked_C");
