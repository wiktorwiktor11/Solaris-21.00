...
static_assert(sizeof(TooltipLibrary_C_Create_Compare_Item_Tooltip) == 0x000138, "Wrong size on TooltipLibrary_C_Create_Compare_Item_Tooltip");
...
static_assert(offsetof(TooltipLibrary_C_Create_Compare_Item_Tooltip, CallFunc_Conv_StringToText_ReturnValue) == 0x0000A8, "Member 'TooltipLibrary_C_Create_Compare_Item_Tooltip::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(TooltipLibrary_C_Create_Compare_Item_Tooltip, K2Node_MakeStruct_FormatArgumentData_1) == 0x0000C0, "Member 'TooltipLibrary_C_Create_Compare_Item_Tooltip::K2Node_MakeStruct_FormatArgumentData_1' has a wrong offset!");
static_assert(offsetof(TooltipLibrary_C_Create_Compare_Item_Tooltip, K2Node_MakeArray_Array) == 0x000110, "Member 'TooltipLibrary_C_Create_Compare_Item_Tooltip::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(TooltipLibrary_C_Create_Compare_Item_Tooltip, CallFunc_Format_ReturnValue) == 0x000120, "Member 'TooltipLibrary_C_Create_Compare_Item_Tooltip::CallFunc_Format_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(TooltipLibrary_C_Create_Item_Tooltip) == 0x000138, "Wrong size on TooltipLibrary_C_Create_Item_Tooltip");
...
static_assert(offsetof(TooltipLibrary_C_Create_Item_Tooltip, CallFunc_Conv_StringToText_ReturnValue) == 0x0000A8, "Member 'TooltipLibrary_C_Create_Item_Tooltip::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(TooltipLibrary_C_Create_Item_Tooltip, K2Node_MakeStruct_FormatArgumentData_1) == 0x0000C0, "Member 'TooltipLibrary_C_Create_Item_Tooltip::K2Node_MakeStruct_FormatArgumentData_1' has a wrong offset!");
static_assert(offsetof(TooltipLibrary_C_Create_Item_Tooltip, K2Node_MakeArray_Array) == 0x000110, "Member 'TooltipLibrary_C_Create_Item_Tooltip::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(TooltipLibrary_C_Create_Item_Tooltip, CallFunc_Format_ReturnValue) == 0x000120, "Member 'TooltipLibrary_C_Create_Item_Tooltip::CallFunc_Format_ReturnValue' has a wrong offset!");
