...
static_assert(sizeof(AAthena_Prop_Plant_Houseplant01_C) == 0x000F60, "Wrong size on AAthena_Prop_Plant_Houseplant01_C");
static_assert(offsetof(AAthena_Prop_Plant_Houseplant01_C, Loot_Effect) == 0x000F58, "Member 'AAthena_Prop_Plant_Houseplant01_C::Loot_Effect' has a wrong offset!");
