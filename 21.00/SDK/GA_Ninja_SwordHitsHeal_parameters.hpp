...
static_assert(sizeof(GA_Ninja_SwordHitsHeal_C_K2_ShouldAbilityRespondToEvent) == 0x000100, "Wrong size on GA_Ninja_SwordHitsHeal_C_K2_ShouldAbilityRespondToEvent");
...
static_assert(offsetof(GA_Ninja_SwordHitsHeal_C_K2_ShouldAbilityRespondToEvent, Payload) == 0x000048, "Member 'GA_Ninja_SwordHitsHeal_C_K2_ShouldAbilityRespondToEvent::Payload' has a wrong offset!");
static_assert(offsetof(GA_Ninja_SwordHitsHeal_C_K2_ShouldAbilityRespondToEvent, ReturnValue) == 0x0000F8, "Member 'GA_Ninja_SwordHitsHeal_C_K2_ShouldAbilityRespondToEvent::ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_Ninja_SwordHitsHeal_C_K2_ShouldAbilityRespondToEvent, CallFunc_ShouldSwordHitsHealRespondToEvent_ReturnValue) == 0x0000F9, "Member 'GA_Ninja_SwordHitsHeal_C_K2_ShouldAbilityRespondToEvent::CallFunc_ShouldSwordHitsHealRespondToEvent_ReturnValue' has a wrong offset!");
