...
static_assert(sizeof(AThreat_RainAttachedToPlayer_C) == 0x000280, "Wrong size on AThreat_RainAttachedToPlayer_C");
static_assert(offsetof(AThreat_RainAttachedToPlayer_C, ParticleSystem) == 0x000270, "Member 'AThreat_RainAttachedToPlayer_C::ParticleSystem' has a wrong offset!");
static_assert(offsetof(AThreat_RainAttachedToPlayer_C, DefaultSceneRoot) == 0x000278, "Member 'AThreat_RainAttachedToPlayer_C::DefaultSceneRoot' has a wrong offset!");
