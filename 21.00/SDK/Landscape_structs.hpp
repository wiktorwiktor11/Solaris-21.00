...
static_assert(sizeof(FGrassInput) == 0x000020, "Wrong size on FGrassInput");
...
public:
	...
	struct FExpressionInput                       LayerInput;                                        // 0x0008(0x000C)(NoDestructor, NativeAccessSpecifierPublic)
	struct FExpressionInput                       HeightInput;                                       // 0x0014(0x000C)(NoDestructor, NativeAccessSpecifierPublic)
	float                                         PreviewWeight;                                     // 0x0020(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                ConstLayerInput;                                   // 0x0028(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ConstHeightInput;                                  // 0x0040(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FLayerBlendInput, HeightInput) == 0x000014, "Member 'FLayerBlendInput::HeightInput' has a wrong offset!");
static_assert(offsetof(FLayerBlendInput, PreviewWeight) == 0x000020, "Member 'FLayerBlendInput::PreviewWeight' has a wrong offset!");
static_assert(offsetof(FLayerBlendInput, ConstLayerInput) == 0x000028, "Member 'FLayerBlendInput::ConstLayerInput' has a wrong offset!");
static_assert(offsetof(FLayerBlendInput, ConstHeightInput) == 0x000040, "Member 'FLayerBlendInput::ConstHeightInput' has a wrong offset!");
...
static_assert(sizeof(FPhysicalMaterialInput) == 0x000018, "Wrong size on FPhysicalMaterialInput");
