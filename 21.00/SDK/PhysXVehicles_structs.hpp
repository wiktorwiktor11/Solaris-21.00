...
static_assert(sizeof(FVehicleAnimInstanceProxy) == 0x000960, "Wrong size on FVehicleAnimInstanceProxy");
...
static_assert(sizeof(FWheelSetup) == 0x000030, "Wrong size on FWheelSetup");
...
static_assert(offsetof(FWheelSetup, bDisableSteering) == 0x000028, "Member 'FWheelSetup::bDisableSteering' has a wrong offset!");
