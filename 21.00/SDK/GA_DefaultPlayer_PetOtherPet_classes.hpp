...
static_assert(sizeof(UGA_DefaultPlayer_PetOtherPet_C) == 0x000B18, "Wrong size on UGA_DefaultPlayer_PetOtherPet_C");
static_assert(offsetof(UGA_DefaultPlayer_PetOtherPet_C, UberGraphFrame) == 0x000B10, "Member 'UGA_DefaultPlayer_PetOtherPet_C::UberGraphFrame' has a wrong offset!");
