...
public:
	...
	uint8                                         bRenderComponentOnly : 1;                          // 0x0064(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	ENiagaraBakerViewMode                         CameraViewportMode;                                // 0x0078(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraBakerSettings) == 0x0001E8, "Wrong size on UNiagaraBakerSettings");
...
static_assert(offsetof(UNiagaraBakerSettings, OutputTextures) == 0x000068, "Member 'UNiagaraBakerSettings::OutputTextures' has a wrong offset!");
static_assert(offsetof(UNiagaraBakerSettings, CameraViewportMode) == 0x000078, "Member 'UNiagaraBakerSettings::CameraViewportMode' has a wrong offset!");
static_assert(offsetof(UNiagaraBakerSettings, CameraViewportLocation) == 0x000080, "Member 'UNiagaraBakerSettings::CameraViewportLocation' has a wrong offset!");
static_assert(offsetof(UNiagaraBakerSettings, CameraViewportRotation) == 0x000128, "Member 'UNiagaraBakerSettings::CameraViewportRotation' has a wrong offset!");
static_assert(offsetof(UNiagaraBakerSettings, CameraOrbitDistance) == 0x0001D0, "Member 'UNiagaraBakerSettings::CameraOrbitDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraBakerSettings, CameraFOV) == 0x0001D4, "Member 'UNiagaraBakerSettings::CameraFOV' has a wrong offset!");
static_assert(offsetof(UNiagaraBakerSettings, CameraOrthoWidth) == 0x0001D8, "Member 'UNiagaraBakerSettings::CameraOrthoWidth' has a wrong offset!");
static_assert(offsetof(UNiagaraBakerSettings, CameraAspectRatio) == 0x0001E0, "Member 'UNiagaraBakerSettings::CameraAspectRatio' has a wrong offset!");
