...
static_assert(sizeof(ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter) == 0x000018, "Wrong size on ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter");
...
static_assert(offsetof(ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter, K2Node_Event_IsDesignTime) == 0x000010, "Member 'ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter::K2Node_Event_IsDesignTime' has a wrong offset!");
static_assert(offsetof(ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter, K2Node_CustomEvent_bItemChanged) == 0x000011, "Member 'ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter::K2Node_CustomEvent_bItemChanged' has a wrong offset!");
static_assert(offsetof(ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter, K2Node_CustomEvent_bAmmoChanged) == 0x000012, "Member 'ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter::K2Node_CustomEvent_bAmmoChanged' has a wrong offset!");
static_assert(offsetof(ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter, K2Node_CustomEvent_bIngredientsChanged) == 0x000013, "Member 'ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter::K2Node_CustomEvent_bIngredientsChanged' has a wrong offset!");
static_assert(offsetof(ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter, CallFunc_IsValid_ReturnValue) == 0x000014, "Member 'ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter, CallFunc_IsValid_ReturnValue_1) == 0x000015, "Member 'ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
