...
public:
	...
	EDataSortTypeEnum                             DataSortingType;                                   // 0x0168(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraDataInterfaceChaosDestruction) == 0x0002F8, "Wrong size on UNiagaraDataInterfaceChaosDestruction");
...
static_assert(offsetof(UNiagaraDataInterfaceChaosDestruction, DataSortingType) == 0x000168, "Member 'UNiagaraDataInterfaceChaosDestruction::DataSortingType' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceChaosDestruction, bGetExternalCollisionData) == 0x000169, "Member 'UNiagaraDataInterfaceChaosDestruction::bGetExternalCollisionData' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceChaosDestruction, DoSpatialHash) == 0x00016A, "Member 'UNiagaraDataInterfaceChaosDestruction::DoSpatialHash' has a wrong offset!");
