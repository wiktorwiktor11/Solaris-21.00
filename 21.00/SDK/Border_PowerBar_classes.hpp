...
static_assert(alignof(UBorder_PowerBar_C) == 0x000010, "Wrong alignment on UBorder_PowerBar_C");
static_assert(sizeof(UBorder_PowerBar_C) == 0x0000F0, "Wrong size on UBorder_PowerBar_C");
