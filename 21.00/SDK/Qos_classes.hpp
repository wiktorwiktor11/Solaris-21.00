...
static_assert(sizeof(AQosBeaconClient) == 0x000338, "Wrong size on AQosBeaconClient");
...
static_assert(sizeof(AQosBeaconHost) == 0x0002A0, "Wrong size on AQosBeaconHost");
