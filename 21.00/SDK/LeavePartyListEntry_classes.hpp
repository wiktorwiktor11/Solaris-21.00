...
static_assert(sizeof(ULeavePartyListEntry_C) == 0x0010A0, "Wrong size on ULeavePartyListEntry_C");
static_assert(offsetof(ULeavePartyListEntry_C, UberGraphFrame) == 0x001050, "Member 'ULeavePartyListEntry_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ULeavePartyListEntry_C, Selected) == 0x001058, "Member 'ULeavePartyListEntry_C::Selected' has a wrong offset!");
static_assert(offsetof(ULeavePartyListEntry_C, Hovered) == 0x001060, "Member 'ULeavePartyListEntry_C::Hovered' has a wrong offset!");
static_assert(offsetof(ULeavePartyListEntry_C, AnimatedInputBorder) == 0x001068, "Member 'ULeavePartyListEntry_C::AnimatedInputBorder' has a wrong offset!");
static_assert(offsetof(ULeavePartyListEntry_C, Arrow) == 0x001070, "Member 'ULeavePartyListEntry_C::Arrow' has a wrong offset!");
static_assert(offsetof(ULeavePartyListEntry_C, EmptyButtonToEatOneMouseUpEvent) == 0x001078, "Member 'ULeavePartyListEntry_C::EmptyButtonToEatOneMouseUpEvent' has a wrong offset!");
static_assert(offsetof(ULeavePartyListEntry_C, EntryBorder) == 0x001080, "Member 'ULeavePartyListEntry_C::EntryBorder' has a wrong offset!");
static_assert(offsetof(ULeavePartyListEntry_C, Text_LeavePartyText) == 0x001088, "Member 'ULeavePartyListEntry_C::Text_LeavePartyText' has a wrong offset!");
static_assert(offsetof(ULeavePartyListEntry_C, UserActionMenuInputButton) == 0x001090, "Member 'ULeavePartyListEntry_C::UserActionMenuInputButton' has a wrong offset!");
