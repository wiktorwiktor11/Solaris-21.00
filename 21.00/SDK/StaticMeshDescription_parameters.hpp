...
static_assert(sizeof(StaticMeshDescription_SetPolygonGroupMaterialSlotName) == 0x000008, "Wrong size on StaticMeshDescription_SetPolygonGroupMaterialSlotName");
