...
public:
	...
	class UCommonActivatablePanelLegacy*          K2Node_Event_ModalPopup;                           // 0x0008(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(PopupCenterMessageWidget_C_ExecuteUbergraph_PopupCenterMessageWidget) == 0x000030, "Wrong size on PopupCenterMessageWidget_C_ExecuteUbergraph_PopupCenterMessageWidget");
...
static_assert(offsetof(PopupCenterMessageWidget_C_ExecuteUbergraph_PopupCenterMessageWidget, K2Node_CreateDelegate_OutputDelegate) == 0x00001C, "Member 'PopupCenterMessageWidget_C_ExecuteUbergraph_PopupCenterMessageWidget::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(PopupCenterMessageWidget_C_ExecuteUbergraph_PopupCenterMessageWidget, CallFunc_K2_SetTimerDelegate_ReturnValue) == 0x000028, "Member 'PopupCenterMessageWidget_C_ExecuteUbergraph_PopupCenterMessageWidget::CallFunc_K2_SetTimerDelegate_ReturnValue' has a wrong offset!");
...
public:
	...
	class UCommonActivatablePanelLegacy*          ModalPopup;                                        // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
