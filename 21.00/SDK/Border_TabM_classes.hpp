...
static_assert(alignof(UBorder_TabM_C) == 0x000010, "Wrong alignment on UBorder_TabM_C");
static_assert(sizeof(UBorder_TabM_C) == 0x0000F0, "Wrong size on UBorder_TabM_C");
