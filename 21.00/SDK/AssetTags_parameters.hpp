...
{
public:
	struct FAssetData                             AssetData;                                         // 0x0000(0x0048)(ConstParm, Parm, OutParm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AssetTagsSubsystem_GetCollectionsContainingAssetData) == 0x000058, "Wrong size on AssetTagsSubsystem_GetCollectionsContainingAssetData");
...
static_assert(offsetof(AssetTagsSubsystem_GetCollectionsContainingAssetData, ReturnValue) == 0x000048, "Member 'AssetTagsSubsystem_GetCollectionsContainingAssetData::ReturnValue' has a wrong offset!");
