...
static_assert(alignof(UButtonStyle_Feature_L_Yellow_C) == 0x000010, "Wrong alignment on UButtonStyle_Feature_L_Yellow_C");
static_assert(sizeof(UButtonStyle_Feature_L_Yellow_C) == 0x000730, "Wrong size on UButtonStyle_Feature_L_Yellow_C");
