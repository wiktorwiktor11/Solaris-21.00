...
static_assert(offsetof(NetDebugContainer_C_ExecuteUbergraph_NetDebugContainer, CallFunc_IsMobileGame_ReturnValue) == 0x000004, "Member 'NetDebugContainer_C_ExecuteUbergraph_NetDebugContainer::CallFunc_IsMobileGame_ReturnValue' has a wrong offset!");
static_assert(offsetof(NetDebugContainer_C_ExecuteUbergraph_NetDebugContainer, K2Node_Event_InVisibility) == 0x000005, "Member 'NetDebugContainer_C_ExecuteUbergraph_NetDebugContainer::K2Node_Event_InVisibility' has a wrong offset!");
static_assert(offsetof(NetDebugContainer_C_ExecuteUbergraph_NetDebugContainer, K2Node_SwitchEnum_CmpSuccess) == 0x000006, "Member 'NetDebugContainer_C_ExecuteUbergraph_NetDebugContainer::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
