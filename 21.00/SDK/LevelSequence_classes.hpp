...
static_assert(sizeof(ULevelSequenceBurnIn) == 0x000368, "Wrong size on ULevelSequenceBurnIn");
static_assert(offsetof(ULevelSequenceBurnIn, FrameInformation) == 0x0002B8, "Member 'ULevelSequenceBurnIn::FrameInformation' has a wrong offset!");
static_assert(offsetof(ULevelSequenceBurnIn, LevelSequenceActor) == 0x000360, "Member 'ULevelSequenceBurnIn::LevelSequenceActor' has a wrong offset!");
