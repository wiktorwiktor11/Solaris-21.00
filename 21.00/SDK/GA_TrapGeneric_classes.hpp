...
public:
	...
	class ABuildingTrap*                          CeilingTrap;                                       // 0x0B18(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<class AActor*>                         TargetArray;                                       // 0x0B20(0x0010)(Edit, BlueprintVisible, DisableEditOnTemplate, DisableEditOnInstance)
...
static_assert(sizeof(UGA_TrapGeneric_C) == 0x000B30, "Wrong size on UGA_TrapGeneric_C");
static_assert(offsetof(UGA_TrapGeneric_C, UberGraphFrame) == 0x000B10, "Member 'UGA_TrapGeneric_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_TrapGeneric_C, CeilingTrap) == 0x000B18, "Member 'UGA_TrapGeneric_C::CeilingTrap' has a wrong offset!");
static_assert(offsetof(UGA_TrapGeneric_C, TargetArray) == 0x000B20, "Member 'UGA_TrapGeneric_C::TargetArray' has a wrong offset!");
