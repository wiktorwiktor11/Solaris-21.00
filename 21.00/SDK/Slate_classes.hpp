...
{
public:
	struct FEditableTextBoxStyle                  EditableTextBoxStyle;                              // 0x0030(0x0AC0)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEditableTextBoxWidgetStyle) == 0x000AF0, "Wrong size on UEditableTextBoxWidgetStyle");
...
{
public:
	struct FEditableTextStyle                     EditableTextStyle;                                 // 0x0030(0x02B0)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEditableTextWidgetStyle) == 0x0002E0, "Wrong size on UEditableTextWidgetStyle");
