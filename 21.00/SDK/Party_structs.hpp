...
static_assert(sizeof(FPartyMemberRepData) == 0x0001B8, "Wrong size on FPartyMemberRepData");
...
static_assert(offsetof(FPartyMemberRepData, JoinMethod) == 0x000178, "Member 'FPartyMemberRepData::JoinMethod' has a wrong offset!");
