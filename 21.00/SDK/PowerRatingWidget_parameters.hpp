...
static_assert(sizeof(PowerRatingWidget_C_ExecuteUbergraph_PowerRatingWidget) == 0x0000C8, "Wrong size on PowerRatingWidget_C_ExecuteUbergraph_PowerRatingWidget");
...
static_assert(offsetof(PowerRatingWidget_C_ExecuteUbergraph_PowerRatingWidget, CallFunc_Greater_FloatFloat_ReturnValue) == 0x0000AB, "Member 'PowerRatingWidget_C_ExecuteUbergraph_PowerRatingWidget::CallFunc_Greater_FloatFloat_ReturnValue' has a wrong offset!");
